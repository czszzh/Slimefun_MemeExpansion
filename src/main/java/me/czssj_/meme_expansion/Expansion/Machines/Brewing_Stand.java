...
public class Brewing_Stand extends AContainer implements NotHopperable
{
    public Brewing_Stand(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe)
    {
    ...
    public boolean isVillagerSoul(ItemStack item) 
    {
        ...
        return sfItem != null && sfItem.getId().equals("EXPANSION_VILLAGER_SOUL");
    }
}