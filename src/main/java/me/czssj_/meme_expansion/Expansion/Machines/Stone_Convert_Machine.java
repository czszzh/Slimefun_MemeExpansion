...
public class Stone_Convert_Machine extends AContainer implements NotHopperable
{
    private int s;

    public Stone_Convert_Machine(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, int speed)
    {
