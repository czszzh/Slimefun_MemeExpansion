...
public class MobItemBan extends LimitedUseItem implements WeaponUseHandler
{
    public static final int MAX_USES = 5;
    private static final NamespacedKey usageKey = new NamespacedKey(Meme_Expansion.getInstance(), "MobItemBan_usage");

    public MobItemBan(SubItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe)
    {
